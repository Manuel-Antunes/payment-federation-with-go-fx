...
func (_c *OrderCreate) SetAmountCents(v int64) *OrderCreate {
...
func (_c *OrderCreate) check() error {
	...
	if _, ok := _c.mutation.AmountCents(); !ok {
		return &ValidationError{Name: "amount_cents", err: errors.New(`ent: missing required field "Order.amount_cents"`)}
	}
...
func (_c *OrderCreate) createSpec() (*Order, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AmountCents(); ok {
		_spec.SetField(order.FieldAmountCents, field.TypeInt64, value)
